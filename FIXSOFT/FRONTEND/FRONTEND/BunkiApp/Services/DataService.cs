...
public class DataService
{
    ...
    {   
        new Alojamiento
        {
            ...
            Reglas = new() { "Sin mascotas, sin fiestas" },
            Resenas = new()
            {
        ...
        new Alojamiento
        {
            ...
            Reglas = new() { "Sin fiestas, sin fumar" },
        },
        new Alojamiento
        {
            Id = 3,
        ...
        new Alojamiento
        {
            ...
            Reglas = new() { "No hacer ruido excesivo después de las 11 PM" },
            Resenas = new()
        },
        new Alojamiento
        {
            ...
            AnfitrionDesde = "2021",
            PoliticaCancelacion = "Moderada - 5 días antes",
            Reglas = new() { "Cuidar las instalaciones, se admiten mascotas pequeñas" },
            Resenas = new()
        },
        new Alojamiento
        {
            ...
            Reglas = new() { "Prohibido fumar, visitas solo hasta las 8 PM" },
            Resenas = new()
        },
        new Alojamiento
        {
            ...
            Reglas = new() { "Prohibido fiestas, mantener la limpieza" },
            Resenas = new()
        },
        new Alojamiento
        {
            ...
            Reglas = new() { "Música a volumen moderado, recoger la basura tras la parrilla" },
            Resenas = new()
        },
        new Alojamiento
        {
            ...
            Reglas = new() { "No mascotas, presentar DNI al llegar" },
            Resenas = new()
        },
        new Alojamiento
        {
            ...
            Reglas = new() { "Sin fiestas, apagar luces al salir" },
            Resenas = new()
        },
        new Alojamiento
        {
            ...
            AnfitrionDesde = "2020",
            PoliticaCancelacion = "Moderada - 5 días antes",
            Reglas = new() { "Respetar los horarios del condominio" },
            Resenas = new()
        },
        new Alojamiento
        {
            ...
            AnfitrionDesde = "2023",
            PoliticaCancelacion = "Flexible - 24 horas antes",
            Reglas = new() { "No fumar dentro del estudio" },
            Resenas = new()
        },
        new Alojamiento
        {
            ...
            AnfitrionDesde = "2024",
            PoliticaCancelacion = "Flexible",
            Reglas = new() { "Mantener el orden en áreas comunes" },
            Resenas = new()
        }
    };
    ...
    // NOTA: las métricas del admin (estadísticas, denuncias, incidencias, alojamientos por
    // aprobar) y las del anfitrión se MIGRARON a datos reales del backend (Admin.razor,
    // PanelAnfitrion.razor, AdminModeracion/AdminIncidencias vía sus *ServiceRest/Provider).
    // Por eso aquí ya no hay mocks de esas métricas. DataService se conserva solo como
    // FALLBACK offline de los Providers (alojamientos/reservas/usuario actual).
