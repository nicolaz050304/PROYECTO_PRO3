...
public class UsuarioDTO {
    ...
    // Validación documentaria (RF02): PENDIENTE / APROBADO / RECHAZADO. El frontend lo usa para
    // mostrar el badge "verificado" y para el gate de publicación. Tipo/numero de documento se
    // exponen para el perfil (el numero ya existía en BD; antes no viajaba al DTO).
