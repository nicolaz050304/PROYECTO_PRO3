...
public final class ReservaMapper {
    ...
    public static ReservaDTO toDTO(Reserva r,
        ...
        // Nº de huéspedes REAL de la reserva (antes era siempre 1).
        dto.setNumHuespedes(r.getNumHuespedes() > 0 ? r.getNumHuespedes() : 1);
    ...
    public static Reserva toEntity(ReservaDTO dto) {
        ...
        r.setNumHuespedes(dto.getNumHuespedes() > 0 ? dto.getNumHuespedes() : 1);
